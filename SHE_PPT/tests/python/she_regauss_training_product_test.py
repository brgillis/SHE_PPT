...
from SHE_PPT.products import she_regauss_training as prod
...
class TestREGAUSSTrainingDataProduct(object):
    ...
    def test_validation(self):
        ...
        # Create the product
        product = prod.create_dpd_she_regauss_training()
    ...
    def test_xml_writing_and_reading(self, tmpdir):
        ...
        write_xml_product(product, "she_regauss_training.xml", workdir=str(tmpdir), allow_pickled=False)

        # Read back the XML file
        loaded_product = read_xml_product("she_regauss_training.xml", workdir=str(tmpdir), allow_pickled=False)
    ...
    def test_pickle_writing_and_reading(self, tmpdir):
        ...
        # Save the product in an XML file
        filename = "she_regauss_training.xml"

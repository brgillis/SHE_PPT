""" @file she_ksb_training_product_test.py
...
from SHE_PPT.products import she_ksb_training as prod
...
class TestKSBTrainingDataProduct(object):
    ...
    def test_validation(self):
        ...
        # Create the product
        product = prod.create_dpd_she_ksb_training()
    ...
    def test_xml_writing_and_reading(self, tmpdir):
        ...
        write_xml_product(product, "she_ksb_training.xml", workdir=str(tmpdir), allow_pickled=False)

        # Read back the XML file
        loaded_product = read_xml_product("she_ksb_training.xml", workdir=str(tmpdir), allow_pickled=False)

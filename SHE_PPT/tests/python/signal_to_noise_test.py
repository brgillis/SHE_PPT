...
class TestCase:
    ...
    def setup(self, tmpdir):
        ...
        self.mdb_filename = self.sync_mdb.absolutePath("SHE_PPT_8_0/sample_mdb.xml")
        ...
        self.qualified_data_images_filename = self.sync_datastack.absolutePath("SHE_CTE_8_0/" + data_images_filename)

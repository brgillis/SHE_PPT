""" @file lensmc_training_data_product_test.py
...
from SHE_PPT.products import lensmc_training_data as prod
...
class TestLensMCTrainingDataProduct(object):
    ...
    def test_xml_writing_and_reading(self, tmpdir):
        ...
        loaded_product = read_xml_product("she_lensmc_training_data.xml", workdir=str(tmpdir), allow_pickled=False)
    ...
    def test_pickle_writing_and_reading(self, tmpdir):
        ...
        # Save the product in an XML file
        filename = tmpdir.join("she_lensmc_training_data.xml")

...
from SHE_PPT.products import mer_final_catalog, vis_calibrated_frame, she_psf_model_image, she_object_id_list, she_exposure_segmentation_map
...
class TestMockData(SheTestCase):
    ...
    def test_mer_segmentation_map(self):
        ...
        #create the product
        prod_filename = create_reprojected_segmentation_map(object_ids, pixel_coords, detectors, wcs_list, workdir=workdir, detector_shape=detector_shape)

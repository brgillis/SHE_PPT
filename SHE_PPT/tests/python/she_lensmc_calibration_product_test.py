...
class TestLensMCTrainingDataProduct(object):
    ...
    def test_xml_writing_and_reading(self, tmpdir):
        ...
        write_xml_product(product, "she_lensmc_calibration.xml", workdir=str(tmpdir), allow_pickled=False)

        # Read back the XML file
        loaded_product = read_xml_product("she_lensmc_calibration.xml", workdir=str(tmpdir), allow_pickled=False)

...
class TestMomentsMLTrainingDataProduct(object):
    ...
    def test_xml_writing_and_reading(self, tmpdir):
        ...
        write_xml_product(product, "she_momentsml_training_data.xml", workdir=str(tmpdir), allow_pickled=False)

        # Read back the XML file
        loaded_product = read_xml_product("she_momentsml_training_data.xml", workdir=str(tmpdir), allow_pickled=False)
    ...
    def test_pickle_writing_and_reading(self, tmpdir):
        ...
        # Save the product in an XML file
        filename = "she_momentsml_training_data.xml"

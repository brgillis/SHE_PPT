...
class TestReconciledLensMcChainsDataProduct(object):
    ...
    def test_xml_writing_and_reading(self, tmpdir):
        ...
        write_xml_product(product, "she_reconciled_lensmc_chains.xml", workdir=str(tmpdir))

        # Read back the XML file
        loaded_product = read_xml_product("she_reconciled_lensmc_chains.xml", workdir=str(tmpdir))

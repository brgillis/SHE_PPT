...
class BFDMomentsTableFormat(object):
    ...
    def __init__(self):
        ...
        self.bfd_moments = set_column_properties(
            "BFD_MOMENTS", is_optional=True, dtype=">f8", fits_dtype="E", length=7)
        self.bfd_deriv_moments_dg1 = set_column_properties(
            "BFD_DM_DG1", is_optional=True, dtype=">f8", fits_dtype="E", length=7)
        self.bfd_deriv_moments_dg2 = set_column_properties(
            "BFD_DM_DG2", is_optional=True, dtype=">f8", fits_dtype="E", length=7)
        self.bfd_deriv_moments_dmu = set_column_properties(
            "BFD_DM_DMU", is_optional=True, dtype=">f8", fits_dtype="E", length=7)
        self.bfd_2ndderiv_moments_dg1dg1 = set_column_properties(
            "BFD_D2M_DG1DG1", is_optional=True, dtype=">f8", fits_dtype="E", length=7)
        self.bfd_2ndderiv_moments_dg1dg2 = set_column_properties(
            "BFD_D2M_DG1DG2", is_optional=True, dtype=">f8", fits_dtype="E", length=7)
        self.bfd_2ndderiv_moments_dg2dg2 = set_column_properties(
            "BFD_D2M_DG2DG2", is_optional=True, dtype=">f8", fits_dtype="E", length=7)
        self.bfd_2ndderiv_moments_dg1dmu = set_column_properties(
            "BFD_D2M_DG1DMU", is_optional=True, dtype=">f8", fits_dtype="E", length=7)
        self.bfd_2ndderiv_moments_dg2dmu = set_column_properties(
            "BFD_D2M_DG2DMU", is_optional=True, dtype=">f8", fits_dtype="E", length=7)
        self.bfd_2ndderiv_moments_dmudmu = set_column_properties(
            "BFD_D2M_DMUDMU", is_optional=True, dtype=">f8", fits_dtype="E", length=7)
        self.bfd_template_weight = set_column_properties(
            "BFD_TMPL_WEIGHT", is_optional=True, dtype=">f8", fits_dtype="E")
        self.bfd_jsuppress = set_column_properties(
            "BFD_JSUPPRESS", is_optional=True, dtype=">f8", fits_dtype="E")
        self.bfd_pqr = set_column_properties(
            "BFD_PQR", is_optional=True, dtype=">f8", fits_dtype="E", length=6)

        self.bfd_cov_even = set_column_properties(
            "BFD_COV_EVEN", is_optional=True, dtype=">f8", fits_dtype="E", length=15)
        self.bfd_cov_odd = set_column_properties(
            "BFD_COV_ODD", is_optional=True, dtype=">f8", fits_dtype="E", length=3)

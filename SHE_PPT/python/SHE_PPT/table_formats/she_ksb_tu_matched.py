...
class SheKsbTUMatchedFormat(SheTUMatchedFormat):
    ...
    def init_table(*args, **kwargs):
        ...
        return initialise_ksb_tu_matched_table(*args, **kwargs)
...
def make_ksb_tu_matched_table_header(model_hash=None,
                                     model_seed=None,
                                     noise_seed=None,
                                     observation_id=None,
                                     pointing_id=None,
...
def initialise_ksb_tu_matched_table(mer_final_catalog=None,
                                    size=None,
    ...
    """
        ...
        @return ksb_tu_matched_table <astropy.table.Table>
    """
    ...
    ksb_tu_matched_table = init_table(tf, optional_columns=optional_columns, init_cols=init_cols, size=size)

    ksb_tu_matched_table.meta = make_ksb_tu_matched_table_header(model_hash=model_hash,
    ...
    assert is_in_format(ksb_tu_matched_table, tf, verbose=True)

    return ksb_tu_matched_table

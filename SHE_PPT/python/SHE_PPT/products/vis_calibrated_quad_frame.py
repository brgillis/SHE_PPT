""" @file vis_calibrated_quad_frame.py

    Created 16 Feb 2024

    Functions to create and output a calibrated_quad_frame data product.
...
def init():
    ...
    binding_class.init_function = create_dpd_vis_calibrated_quad_frame
...
def create_dpd_vis_calibrated_quad_frame(data_filename="None",
    ...
    return dpd_vis_calibrated_quad_frame

...
from EuclidDmBindings.dpd.sim.raw.starscatalogproduct_stub import dpdStarsCatalogProduct
...
def __get_data_filenames(self):
    ...
    for star_catalog in self.Data.SetOfStarCatalogs:
        filename = star_catalog.StarCatalogFitsFile.DataContainer.FileName

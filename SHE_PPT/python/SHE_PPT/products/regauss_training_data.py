...
def create_dpd_she_regauss_training_data(filename = None):
    ...
    # dpd_she_regauss_training_data = she_dpd.DpdSheREGAUSSTrainingDataProduct() # FIXME
    ...
    dpd_she_regauss_training_data.Data = create_she_regauss_training_data(filename)
...
def create_she_regauss_training_data(filename = None):
    ...
    # she_regauss_training_data = she_dpd.SheREGAUSSTrainingDataProduct() # @FIXME

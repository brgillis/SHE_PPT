...
def create_dpd_she_stack_reproj_seg_map_data(filename):
...
# Add a useful alias
create_stack_reproj_seg_map_data_product = create_dpd_she_stack_reproj_seg_map_data


def create_she_stack_reproj_seg_map_data(filename=None):
    """
        @TODO fill in docstring
    """

    # she_stack_reproj_seg_map_data = she_dpd.SheKSBTrainingDataProduct() # @FIXME
    she_stack_reproj_seg_map_data = SheStackReprojectedSegmentationMapProduct()

    she_stack_reproj_seg_map_data.format = "UNDEFINED"
    she_stack_reproj_seg_map_data.version = "0.0"

    she_stack_reproj_seg_map_data.DataContainer = DataContainer()
    she_stack_reproj_seg_map_data.DataContainer.FileName = filename
    she_stack_reproj_seg_map_data.DataContainer.filestatus = "PROPOSED"

    return she_stack_reproj_seg_map_data

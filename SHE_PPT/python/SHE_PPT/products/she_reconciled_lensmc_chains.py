...
def create_dpd_she_reconciled_lensmc_chains(filename="None",
    ...
    dpd_she_reconciled_lensmc_chains.Header = HeaderProvider.create_generic_header("SHE")

    if filename:
        __set_filename(dpd_she_reconciled_lensmc_chains, filename)
    if spatial_footprint is not None:
        __set_spatial_footprint(dpd_she_reconciled_lensmc_chains, spatial_footprint)

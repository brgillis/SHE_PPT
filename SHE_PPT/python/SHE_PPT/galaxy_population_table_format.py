...
class GalaxyPopulationTableFormat(object):
    ...
    def __init__(self):
        ...
        self.bulge_fd_B = set_column_properties("B_FD_B", comment="nJy")
        self.bulge_fd_B_err = set_column_properties("B_FD_B_ERR", comment="nJy")
        self.bulge_fd_V = set_column_properties("B_FD_V", comment="nJy")
        self.bulge_fd_V_err = set_column_properties("B_FD_V_ERR", comment="nJy")
        self.bulge_fd_I = set_column_properties("B_FD_I", comment="nJy")
        self.bulge_fd_I_err = set_column_properties("B_FD_I_ERR", comment="nJy")
        self.bulge_fd_Z = set_column_properties("B_FD_Z", comment="nJy")
        self.bulge_fd_Z_err = set_column_properties("B_FD_Z_ERR", comment="nJy")
        self.bulge_fd_Y = set_column_properties("B_FD_Y", comment="nJy")
        self.bulge_fd_Y_err = set_column_properties("B_FD_Y_ERR", comment="nJy")
        self.bulge_fd_J = set_column_properties("B_FD_J", comment="nJy")
        self.bulge_fd_J_err = set_column_properties("B_FD_J_ERR", comment="nJy")
        self.bulge_fd_H = set_column_properties("B_FD_H", comment="nJy")
        self.bulge_fd_H_err = set_column_properties("B_FD_H_ERR", comment="nJy")
        
        self.disk_fd_B = set_column_properties("D_FD_B", comment="nJy")
        self.disk_fd_B_err = set_column_properties("D_FD_B_ERR", comment="nJy")
        self.disk_fd_V = set_column_properties("D_FD_V", comment="nJy")
        self.disk_fd_V_err = set_column_properties("D_FD_V_ERR", comment="nJy")
        self.disk_fd_I = set_column_properties("D_FD_I", comment="nJy")
        self.disk_fd_I_err = set_column_properties("D_FD_I_ERR", comment="nJy")
        self.disk_fd_Z = set_column_properties("D_FD_Z", comment="nJy")
        self.disk_fd_Z_err = set_column_properties("D_FD_Z_ERR", comment="nJy")
        self.disk_fd_Y = set_column_properties("D_FD_Y", comment="nJy")
        self.disk_fd_Y_err = set_column_properties("D_FD_Y_ERR", comment="nJy")
        self.disk_fd_J = set_column_properties("D_FD_J", comment="nJy")
        self.disk_fd_J_err = set_column_properties("D_FD_J_ERR", comment="nJy")
        self.disk_fd_H = set_column_properties("D_FD_H", comment="nJy")
        self.disk_fd_H_err = set_column_properties("D_FD_H_ERR", comment="nJy")
